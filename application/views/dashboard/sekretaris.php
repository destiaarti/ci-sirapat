...
<section class="content">
   ...
   <p>&nbsp;</p>  
		...
		$get3 =$this->db->get_where("tb_users",array("id" =>$id))->row();
                        ...
                        <h1> <font color="yellow">Selamat Datang </font><font color="red"><em><?php echo $tanggal11; ?> ,</em></font></h1>
							      ...
							      <h3> <font color="white">Anda login sebagai  <strong>Sekretaris</strong>,</font>  </h3> 
                          <h3> <font color="white" size="4">   Anda dapat menginput data hasil rapat dan mencetak surat.  </font>                            </h3>  
                        </p>
   <p>&nbsp;</p>
            ...
            <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12"><a href="<?php echo base_url('member/liat')?>">
  ...
  <br>
            ...
            <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <a href="<?php echo base_url('jadwal/liat')?>"><div class="tile-stats3">
                <div class="icon"><i class="fa fa-calendar"></i>
                </div>
              
              
                           
                <div class="count"><font color ="yellow"> <?php echo $jadwal; ?></font></div>
<br>      
	  <h3><font color ="white">Jadwal Rapat</font></h3>
                <p>&nbsp;</p>
              </div></a>
            </div>
            <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <a href="<?php echo base_url('hasil/index')?>"><div class="tile-stats4">
...
<br>
			 ...
			 <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12"><a href="<?php echo base_url('files')?>">
              ...
              <div class="count"><font color ="yellow"> <?php echo $files; ?></font></div>
<br>
                <h3><font color ="white">File Rapat</font></h3>
                <p>&nbsp;</p>
              ...
              <div class="box box-success">
                ...
                <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
                    ...
                    <ul class="pagination pagination-sm no-margin pull-right">
                      ...
                      <li><a href="<?php echo site_url('jadwal/liat'); ?>" class="btn btn-sm btn-default btn-flat pull-right">Lihat Semua Jadwal Rapat</a></li>
                    </ul>
              ...
              <div class="box box-success">
                ...
                <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
                    ...
                    <ul class="pagination pagination-sm no-margin pull-right">
                      ...
                      <li>   <li><a href="<?php echo site_url('hasil/index'); ?>" class="btn btn-sm btn-default btn-flat pull-right">Lihat Semua Data Hasil</a></li>
                    </ul></li>
                    </ul>
              ...
              <div class="box box-success">
                ...
                <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
                    ...
                    <ul class="pagination pagination-sm no-margin pull-right">
                      ...
                      <li>   <li><a href="<?php echo site_url('download'); ?>" class="btn btn-sm btn-default btn-flat pull-right">Lihat Semua Data Berkas</a></li>
                    </ul></li>
                    </ul>
                ...
                <div class="box-body no-padding">
                  <table class="table no-margin">
                    ...
                    <tbody>
                        ...
                        foreach ($download1 as $download1) {
						
                            ?>
                            <tr>
                       
                    
                                <td><?php echo anchor('download/read/' . $download1->id, $download1->file_judul) ?></td>
								   <td><?php echo $download1->file_rapat ?></td>
								   <td><?php echo $download1->file_deskripsi ?></td>
								   <td style="text-align:center;"><a href="<?php echo site_url('download/get_file/'.$download1->id);?>" class="btn btn-success">Download</a></td>
