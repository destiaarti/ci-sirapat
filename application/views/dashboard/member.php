    ...
    <?php 	    $id = $this->session->userdata('user_id');
		$get3 =$this->db->get_where("tb_users",array("id" =>$id))->row();
                        ...
                        <h1> <font color="yellow">Selamat Datang </font><font color="red"><em><?php echo $tanggal11; ?>,</em></font></h1>
							      ...
							      <h3> <font color="white">Anda login sebagai  <strong>Member</strong>,</font>  </h3> 
                          <h3> <font color="white" size="4">   Anda dapat melihat data member dan jadwal rapat.  </font>                            </h3>  
                        </p>
   <p>&nbsp;</p>
...
<br>
			 ...
			 <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12"><a href="<?php echo base_url('download')?>">
