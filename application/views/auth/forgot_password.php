...
<html>
    <head>
        <meta charset="UTF-8">
        <title>SMPN 1 Ungaran | Forgot Password</title>
    ...
    <body class="login-page">
        <div class="login-box">
            <div class="login-logo">
                         <a href="#" ><b class="primary-color">SI</b><font color= "green">  Rapat</a></font></br>
				 <a href="#" ><b class="success-color">SMPN 1 UGARAN</a>
            </div><!-- /.login-logo -->
            <div class="login-box-body">
                <p class="login-box-msg text-bold">Silakan masukan email anda untuk mereset password.</p>
				    <p class="login-box-msg">(Jika sudah memasukan email,silakan cek email anda))</p>
