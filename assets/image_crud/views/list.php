<?php
	...
	//$this->set_css('assets/assets/plugins/Font-Awesome/css/font-awesome.css');
	$this->set_css('assets/assets/plugins/timepicker/css/bootstrap-timepicker.min.css');
$this->set_css('assets/gantella/css/bootstrap5.min.css' );
	
	//	$this->set_css('assets/gantella/fonts/css/font-awesome.min.css');
			//$this->set_css('assets/gantella/css/custom8.css' );
				$this->set_css('assets/gantella/css/icheck/flat/green.css');
					$this->set_css('assets/gantella/css/floatexamples.css' );
								$this->set_css('assets/gantella/css/maps/jquery-jvectormap-2.0.3.css' );
